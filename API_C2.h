...
typedef struct 
{
    ...
    uint8_t      buttons;      /**< Bitmap of the button states */
    /*uint16_t     xStrength;*/ /*finger strength on X axis*/
    /*uint16_t     yStrength;*/ /*finger strength on Y axis*/    
} CRQabsoluteReport_t; 
...
void API_C2_enableAbsXYZZ(void);
void API_C2_disableAbsXYZZ(void);
void API_C2_invertY(void);
void API_C2_revertY(void);
void API_C2_enableJitter(void);
void API_C2_disableJitter(void);
void API_C2_enablePTPJitter(void);
void API_C2_disablePTPJitter(void);
void API_C2_enableSmoothing(void);
void API_C2_disableSmoothing(void);
void API_C2_disablePTPSmoothing(void);
void API_C2_enablePTPSmoothing(void);
void API_C2_enablePTPLeastChange(void);
void API_C2_disablePTPLeastChange(void);
void API_C2_enableLeastChange(void);
void API_C2_disableLeastChange(void);
void API_C2_enableHoverFilter(void);
void API_C2_disableHoverFilter(void);
void API_C2_setADCGain(uint8_t value);
uint16_t readFingerStrengthX(void);
uint16_t readFingerStrengthY(void);
uint16_t readXPhysicalSize(void);
uint16_t readYPhysicalSize(void);
void API_C2_enableAdvancedAbs(void);
void API_C2_disableAdvancedAbs(void);
void API_C2_enableSingleFingerMode(void);
void API_C2_disableSingleFingerMode(void);
bool API_C2_logicalScalingEnabled(void);
void API_C2_enableLogicalScaling(void);
void API_C2_disableLogicalScaling(void);
uint16_t API_C2_GetFingerTouchThreshold(void);
uint16_t API_C2_GetFingerLiftOffThreshold(void);
void API_C2_SetFingerTouchThreshold(uint16_t value);
void API_C2_SetFingerLiftOffThreshold(uint16_t value);
uint16_t API_C2_GetLogicalScalingXMin(void);
void API_C2_SetLogicalScalingXMin(uint16_t value);
uint16_t API_C2_GetLogicalScalingXMax(void);
void API_C2_SetLogicalScalingXMax(uint16_t value);
uint16_t API_C2_GetLogicalScalingYMin(void);
void API_C2_SetLogicalScalingYMin(uint16_t value);
uint16_t API_C2_GetLogicalScalingYMax(void);
void API_C2_SetLogicalScalingYMax(uint16_t value);
uint8_t API_C2_getADCGain(void);
uint16_t API_C2_GetActualXMin(void);
uint16_t API_C2_GetActualXMax(void);
uint16_t API_C2_GetActualYMin(void);
uint16_t API_C2_GetActualYMax(void);
